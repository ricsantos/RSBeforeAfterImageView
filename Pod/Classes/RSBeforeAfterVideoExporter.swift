    ...
    private func generateFrames(
        ...
        for segment in segments {
            ...
            for frameIndex in 0..<segmentFrameCount {
                // Wait for writer to be ready (but don't use Thread.sleep)
                ...
                // Update position and render frame directly on main thread
                beforeAfterView.setDividerPosition(framePosition, animated: false)
                
                guard let buffer = createPixelBuffer(from: offscreenView, 
